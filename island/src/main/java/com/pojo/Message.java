...
public class Message {
    ...
    public Message(Integer id, Integer userId, String contents, String images, Integer praiseCount, String prsiaeId, Integer commentCount, Boolean isDeleted, Date time) {
        this.id = id;
        this.userId = userId;
